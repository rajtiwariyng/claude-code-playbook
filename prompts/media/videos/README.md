...
> [!NOTE]
> **Status: planned for v1.3.** This folder has no entries yet. Its scope and
...
> [!IMPORTANT]
> Captions and transcripts are an accessibility requirement, not an enhancement. See [quality/accessibility/](../../quality/accessibility/).

## Planned Entries

| Entry | Status |
| --- | --- |
| `video-brief.md` | Planned |
| `script-writing.md` | Planned |
| `captions-and-transcripts.md` | Planned |
| `video-delivery.md` | Planned |
| `video-performance.md` | Planned |
