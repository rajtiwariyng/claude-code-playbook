...
> [!IMPORTANT]
> The sourcing and licensing policy is defined in [assets/](../../../assets/) and applies repository-wide.

## Planned Entries

| Entry | Status |
| --- | --- |
| `image-sourcing.md` | Planned |
| `ai-image-prompts.md` | Planned |
| `image-optimisation.md` | Planned |
| `alt-text.md` | Planned |
| `art-direction.md` | Planned |
