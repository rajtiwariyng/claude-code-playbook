...
| Folder | Owns | Status |
| --- | --- | --- |
| [images/](images/) | Sourcing, generation, optimisation | Planned v1.2 |
| [videos/](videos/) | Production, delivery, accessibility | Planned v1.3 |

> [!IMPORTANT]
> Sourcing and licensing policy is defined in [assets/](../../assets/) and applies repository-wide.
