...
> [!IMPORTANT]
> A test that asserts the implementation rather than the behaviour is a defect. See [core/system/code-reviewer.md](../../core/system/code-reviewer.md).

## Planned Entries

| Entry | Status |
| --- | --- |
| `test-strategy.md` | Planned |
| `unit-testing.md` | Planned |
| `integration-testing.md` | Planned |
| `end-to-end-testing.md` | Planned |
| `test-review.md` | Planned |
| `coverage-analysis.md` | Planned |
