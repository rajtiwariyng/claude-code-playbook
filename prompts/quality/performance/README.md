...
> [!IMPORTANT]
> Deliberately authoritative, for the same reason as [quality/security/](../security/).

## Planned Entries

| Entry | Status |
| --- | --- |
| `core-web-vitals.md` | Planned |
| `performance-budget.md` | Planned |
| `query-performance.md` | Planned |
| `caching-strategy.md` | Planned |
| `asset-optimisation.md` | Planned |
| `profiling.md` | Planned |
