...
> [!IMPORTANT]
> Deliberately authoritative. Baseline is WCAG 2.2 Level AA, treated as a floor rather than a target.

## Planned Entries

| Entry | Status |
| --- | --- |
| `wcag-audit.md` | Planned |
| `keyboard-navigation.md` | Planned |
| `screen-reader-testing.md` | Planned |
| `forms-accessibility.md` | Planned |
| `colour-and-contrast.md` | Planned |
| `accessible-components.md` | Planned |
| `accessibility-statement.md` | Planned |
