...
| Folder | Owns | Status |
| --- | --- | --- |
| [wordpress/](wordpress/) | Themes, plugins, hardening | Planned v1.2 |
| [shopify/](shopify/) | Themes, apps, storefronts | Planned v1.2 |
| [medusajs/](medusajs/) | Medusa commerce | Planned v1.2 |
