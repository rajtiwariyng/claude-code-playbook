...
> [!IMPORTANT]
> Framework folders link here rather than defining their own schema entries.

## Planned Entries

| Entry | Status |
| --- | --- |
| `schema-design.md` | Planned |
| `indexing-strategy.md` | Planned |
| `migration-plan.md` | Planned |
| `query-optimisation.md` | Planned |
| `data-modelling.md` | Planned |
| `backup-and-recovery.md` | Planned |
