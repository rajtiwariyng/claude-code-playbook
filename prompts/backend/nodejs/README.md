...
> [!IMPORTANT]
> API contract design is owned by [backend/api/](../api/).

## Planned Entries

| Entry | Status |
| --- | --- |
| `service-architecture.md` | Planned |
| `express-api.md` | Planned |
| `error-handling.md` | Planned |
| `streams-and-backpressure.md` | Planned |
| `nodejs-performance.md` | Planned |
| `nodejs-testing.md` | Planned |
| `process-management.md` | Planned |
