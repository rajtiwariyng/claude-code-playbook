...
> [!IMPORTANT]
> This folder owns every slide deck. [business/company-profile/](../company-profile/) and [business/sales/](../sales/) link here rather than defining their own deck entries.

## Planned Entries

| Entry | Status |
| --- | --- |
| `pitch-deck.md` | Planned |
| `investor-deck.md` | Planned |
| `sales-deck.md` | Planned |
| `business-proposal-deck.md` | Planned |
| `case-study-presentation.md` | Planned |
| `annual-report.md` | Planned |
| `marketing-deck.md` | Planned |
| `presentation-narrative.md` | Planned |
