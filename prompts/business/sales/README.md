...
> [!IMPORTANT]
> A priced, scoped offer is owned by [business/proposal/](../proposal/). Decks are owned by [business/presentations/](../presentations/).

## Planned Entries

| Entry | Status |
| --- | --- |
| `sales-narrative.md` | Planned |
| `discovery-call-framework.md` | Planned |
| `objection-handling.md` | Planned |
| `outreach-sequence.md` | Planned |
| `competitive-positioning.md` | Planned |
