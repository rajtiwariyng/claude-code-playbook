...
> [!IMPORTANT]
> The narrative that precedes a proposal is owned by [business/sales/](../sales/).

## Planned Entries

| Entry | Status |
| --- | --- |
| `project-proposal.md` | Planned |
| `statement-of-work.md` | Planned |
| `pricing-structure.md` | Planned |
| `scope-definition.md` | Planned |
| `proposal-review.md` | Planned |
