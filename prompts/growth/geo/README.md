...
> [!NOTE]
> **Status: planned for v1.2.** This folder has no entries yet. Its scope and
...
> [!IMPORTANT]
> Named GEO to disambiguate from geography. Traditional search is owned by [growth/seo/](../seo/); the two are kept strictly separate because their tactics differ and conflating them produces advice that serves neither.

## Planned Entries

| Entry | Status |
| --- | --- |
| `geo-fundamentals.md` | Planned |
| `answerable-content.md` | Planned |
| `citation-worthiness.md` | Planned |
| `structured-data-for-retrieval.md` | Planned |
| `geo-audit.md` | Planned |
