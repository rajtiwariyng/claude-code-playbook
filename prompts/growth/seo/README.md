...
> [!IMPORTANT]
> Optimisation for AI answer engines is owned by [growth/geo/](../geo/). The two must not restate each other's tactics. Core Web Vitals are owned by [quality/performance/](../../quality/performance/).

## Planned Entries

| Entry | Status |
| --- | --- |
| `keyword-research.md` | Planned |
| `content-strategy.md` | Planned |
| `metadata.md` | Planned |
| `structured-data.md` | Planned |
| `internal-linking.md` | Planned |
| `technical-seo.md` | Planned |
| `image-optimisation.md` | Planned |
| `seo-audit.md` | Planned |
