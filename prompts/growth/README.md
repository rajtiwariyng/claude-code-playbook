...
| Folder | Owns | Status |
| --- | --- | --- |
| [seo/](seo/) | Traditional search optimisation | Planned v1.1 |
| [geo/](geo/) | Generative engine optimisation | Planned v1.2 |
| [blogs/](blogs/) | Long-form written content | Planned v1.2 |

> [!IMPORTANT]
> `seo` and `geo` are kept strictly separate. Their tactics differ, and conflating them produces advice that serves neither.
