...
> [!IMPORTANT]
> Search strategy is owned by [growth/seo/](../seo/). The writing *role* is owned by [core/system/technical-writer.md](../../core/system/technical-writer.md).

## Planned Entries

| Entry | Status |
| --- | --- |
| `article-brief.md` | Planned |
| `long-form-article.md` | Planned |
| `technical-article.md` | Planned |
| `editorial-calendar.md` | Planned |
| `content-audit.md` | Planned |
