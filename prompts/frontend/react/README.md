...
> [!IMPORTANT]
> React patterns used inside a Next.js app are owned here; [frontend/nextjs/](../nextjs/) covers only framework-specific concerns.

## Planned Entries

| Entry | Status |
| --- | --- |
| `react-architecture.md` | Planned |
| `component-design.md` | Planned |
| `hooks-patterns.md` | Planned |
| `state-management.md` | Planned |
| `react-performance.md` | Planned |
| `react-testing.md` | Planned |
| `react-accessibility.md` | Planned |
