...
> [!IMPORTANT]
> General React patterns are owned by [frontend/react/](../react/) and are not repeated here.

## Planned Entries

| Entry | Status |
| --- | --- |
| `rendering-strategy.md` | Planned |
| `app-router-architecture.md` | Planned |
| `server-components.md` | Planned |
| `data-fetching.md` | Planned |
| `nextjs-seo.md` | Planned |
| `nextjs-deployment.md` | Planned |
