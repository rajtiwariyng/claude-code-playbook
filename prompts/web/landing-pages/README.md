...
> [!IMPORTANT]
> A landing page is not a small website. Multi-page sites are owned by [web/websites/](../websites/).

## Planned Entries

| Entry | Status |
| --- | --- |
| `campaign-landing-page.md` | Planned |
| `product-launch-page.md` | Planned |
| `lead-capture-page.md` | Planned |
| `landing-page-audit.md` | Planned |
| `ab-test-design.md` | Planned |
