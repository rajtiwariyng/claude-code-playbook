...
| Folder | Owns | Status |
| --- | --- | --- |
| [system/](system/) | Roles, output contracts, and project constitution | Complete |
| [research/](research/) | Establishing what is true | Complete |
| [planning/](planning/) | Turning decisions into verifiable plans | Planned v1.1 |
| [documentation/](documentation/) | READMEs, API docs, runbooks | Planned v1.1 |

> [!IMPORTANT]
> **Authoritative.** Roles and research method live here and are referenced everywhere else rather than restated.
