...
> [!IMPORTANT]
> The documentation *role* is owned by [core/system/technical-writer.md](../system/technical-writer.md) and is not restated here.
...
| `runbook.md` | Planned |
| `architecture-decision-record.md` | Planned |
| `changelog.md` | Planned |
| `onboarding-guide.md` | Planned |
