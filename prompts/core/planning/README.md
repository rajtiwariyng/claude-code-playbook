...
> [!IMPORTANT]
> Planning consumes a decision from [core/system/software-architect.md](../system/software-architect.md). If the decision is not made yet, that entry comes first.

## Planned Entries

| Entry | Status |
| --- | --- |
| `feature-plan.md` | Planned |
| `refactor-plan.md` | Planned |
| `migration-plan.md` | Planned |
| `spike-plan.md` | Planned |
| `estimation.md` | Planned |
